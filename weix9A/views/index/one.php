...
<!--				<img src="../bootstrap-3.3.5-dist/files/install.php">-->
			</div>
		...
		<form class="form-inline" role="form" method="post" action="index.php?r=index/next">
			<ul class="pager">
				...
				<li class="previous">
                    <a href="javascript:;" onclick="if(jQuery(&#39;:checkbox:checked&#39;).length == 1){
