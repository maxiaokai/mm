...
<link rel="stylesheet" href="../bootstrap-3.3.5-dist/css/bootstrap.min.css"/>
	...
	<form class="form-horizontal" method="post" action="index.php?r=index/last"  role="form">
<!--		<div class="panel panel-default">-->
...
<!--		</div>-->
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input class="form-control" type="text" name="dbserver" value="127.0.0.1">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input class="form-control" type="text" name="prefix" value="3306">
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">数据库名称</label>
					<div class="col-sm-4">
						<input class="form-control" type="text" name="name" value="we7">
					</div>
				</div>
			</div>
		</div>
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input class="form-control" type="username" name="u_username">
					</div>
				</div>
				<div class="form-group">
		...
		<ul class="pager">
			...
			<li class="previous"><a href="javascript:;" onclick="if(check(this)){jQuery(&#39;#do&#39;).val(&#39;con&#39;);if($(&#39;input[name=type]&#39;).val() == &#39;remote&#39;){alert(&#39;在线线安装时，安装程序会下载精简版快速完成安装，完成后请务必注册云服务更新到完整版。&#39;)}$(&#39;form&#39;)[0].submit();}">继续 <span class="glyphicon glyphicon-chevron-right"></span></a></li>
		</ul>
	</form>
	<script>
		var lock = false;
