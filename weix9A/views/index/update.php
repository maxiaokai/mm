                        ...
                        <div class="sub-content">
                            <table class="tb"  border="1">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input style="width: 500px" name="wetoken" ids="<?php echo $val['id'] ?>" class="token" value="<?php echo $val['atoken'] ?>" type="text"> <a href="javascript:void(0)" class="rand">生成新的</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input name="aid" value="<?php echo $val['id'] ?>" type="hidden">
